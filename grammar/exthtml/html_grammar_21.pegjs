...
BEGIN OF (Perdendo atributos acima do primeiro)
<input type="submit" attr="ok">)
<input type="submit" @event="fn">
<input type="submit" attr="ok" attr2="ok2">
END OF (Perdendo atributos acima do primeiro)
-->
 ...
 * Element attributes
 */
Attributes = __ attrs:( Attribute / DynamicAttribute / EventAttribute )* __ { return attrs; }

Attribute "attribute" = name:AttrName __ text:(__ '=' __ s:DoubleQuoteString)? ( Attributes / (__ &CloseTag __) ) { return { name: name, value: (text && text[3]) ? text[3] : "", type:"attr"}}

DynamicAttribute "dynamic attribute" = name:AttrName __ text:(__ '=' __ s:VariableQuoteString)? ( Attributes / (__ &CloseTag __) ) { return { name: name, value: (text && text[3]) ? text[3] : "", type:"dyn_attr"}}

EventAttribute "event attribute" = '@'name:AttrName __ text:(__ '=' __ s:String)? ( Attributes / (__ &CloseTag __) ) { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr"}}
