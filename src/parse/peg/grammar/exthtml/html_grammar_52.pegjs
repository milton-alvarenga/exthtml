...
EventAttribute "event attribute" = ( '@'name:HTMLAttrName event_modifiers:('.'EventModifiers)* text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr", category: "html_attribute", modifiers:event_modifiers.map(v=>v[1])}} )
								   / ( '@'name:AttrName event_modifiers:('.'EventModifiers)* text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr", category: "directive", modifiers:event_modifiers.map(v=>v[1])}} ) 
...
/**
TODO
HTMLEventName "html event name" = 'list_of_events_here'
*/

EventModifiers = 'stop' / 'prevent' / 'capture' / 'self' / 'once' / 'passive'
