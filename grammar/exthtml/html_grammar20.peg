...
Attribute "attribute" = name:AttrName __ text:(__ '=' __ s:DoubleQuoteString)? __ &CloseTag __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"attr"}}

DynamicAttribute "dynamic attribute" = name:AttrName __ text:(__ '=' __ s:VariableQuoteString)? __ &CloseTag __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"dyn_attr"}}

EventAttribute "event attribute" = '@'name:AttrName __ text:(__ '=' __ s:String)? __ &CloseTag __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr"}}
