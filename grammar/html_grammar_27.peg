//INPUT (QUEBRANDO COM DYNAMIC ATTRIBUTE
<input type="val" type2="val2" type3="val3" @type4="" type5={}/>
<input type="val"/>
<input type="val" type2="val2"/>


<input type={jsvar} />
<input type={jsvar} type2="jsvar2" type3="jsvar3" />
<input type={jsvar} type2="jsvar2" type3="jsvar3" />
...
EventAttribute "event attribute" = '@'name:AttrName __ text:(__ '=' __ s:DoubleQuoteString)? __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr"}}
