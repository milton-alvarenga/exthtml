/**
* Work by @alsotang
* Github: https://github.com/alsotang/sql.pegjs/blob/master/lib/sql.pegjs
* Original project: https://github.com/steveyen/sqld3
* Please, star his project if you are using this code or part of it.
*/
