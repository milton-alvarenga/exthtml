...
StaticAttribute "attribute" = ( name:HTMLAttrName __ text:(__ '=' __ s:DoubleQuoteString)?  __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"attr", category: "html_attribute"}} )
							  / ( name:AttrName __ text:(__ '=' __ s:DoubleQuoteString)?  __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"attr", category: "directive"}} )

DynamicAttribute "dynamic attribute" = ( name:HTMLAttrName __ text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"dyn_attr", category: "html_attribute"}} )
									   / ( name:AttrName __ text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"dyn_attr", category: "directive"}} )

EventAttribute "event attribute" = ( '@'name:HTMLAttrName __ text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr", category: "html_attribute"}} )
								   / ( '@'name:AttrName __ text:(__ '=' __ s:VariableQuoteString) __ { return { name: name, value: (text && text[3]) ? text[3] : "", type:"event_attr", category: "directive"}} ) 
